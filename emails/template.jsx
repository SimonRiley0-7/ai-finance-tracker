import { Button, Html, Head, Preview, Container, Body, Heading, Text, Section } from "@react-email/components";
        ...
        <Container style={styles.container}>
            ...
            <Section style = {styles.statsContainer}>
                ...
                <div style={styles.stat}>
                    ...
                    <Text style = {styles.text}>₹{data?.budgetAmount - data?.totalExpenses}</Text>
                </div>
            </Section>
        </Container>
      </Body>
